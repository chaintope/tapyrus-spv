...
mod tests {
    ...
    fn decode_test() {
        let data: [u8; 137] = [
            ...
            0x00, 0x00, 0x69, 0x00, 0x00, 0x00, 0xc6, 0x98, 0x6d, 0xb8, 0x71, 0x11, 0x01, 0x00,
            ...
            0x62, 0xa8, 0xb3, 0x2b, 0x38, 0x92, 0x13, 0x2f, 0x74, 0x61, 0x70, 0x79, 0x72, 0x75,
            0x73, 0x2d, 0x73, 0x70, 0x76, 0x3a, 0x30, 0x2e, 0x31, 0x2e, 0x30, 0x2f, 0x00, 0x00,
        ...
        {
            assert_eq!(msg.user_agent, "/tapyrus-spv:0.1.0/".to_string());
        } else {
            assert!(false);
        }
